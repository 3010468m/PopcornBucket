...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        reviews_data = [
            ("alice", "Inception", 4, "Clever, layered and still one of the most exciting sci-fi films ever."),
            ("bob", "Interstellar", 4, "Huge ideas, emotional storytelling, and a brilliant score."),
            ("charlie", "The Matrix", 5, "Stylish, influential and endlessly rewatchable."),
            ("alice", "The Dark Knight", 5, "A gripping superhero film with an unforgettable villain."),
            ("bob", "Joker", 3, "Dark and unsettling, with a powerful lead performance."),
            ("charlie", "Mad Max: Fury Road", 4, "Relentless energy and incredible action from start to finish."),
            ("alice", "Parasite", 4, "Sharp, tense and full of social commentary."),
            ("bob", "Fight Club", 4, "Bold and provocative, with a memorable twist."),
            ("charlie", "Se7en", 3, "Bleak, intense and brilliantly constructed."),
            ("alice", "Whiplash", 4, "Intense, gripping, and brilliantly acted."),
            ("bob", "Forrest Gump", 4, "Warm, funny and emotional with a classic central performance."),
            ("charlie", "Schindler's List", 5, "Heartbreaking and essential cinema."),
            ("alice", "Spirited Away", 5, "Beautifully animated and full of imagination."),
            ("bob", "Finding Nemo", 3, "Funny, heartfelt and perfect for families."),
            ("charlie", "WALL-E", 4, "Inventive, touching and visually wonderful."),
            ("alice", "Toy Story", 3, "A timeless and charming animation classic."),
            ("bob", "Back to the Future", 5, "Fast, funny and one of the most entertaining films ever made."),
            ("charlie", "The Truman Show", 5, "Smart, funny and surprisingly emotional."),
        ]
